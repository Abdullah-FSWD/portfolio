...
const HeroSection = () => {
  return (
    <>
      ...
      <div
        className="pt-36 sm:p-0 sm:min-h-screen flex flex-col items-center justify-center relative"
        id="#home"
      >
        <div className="flex flex-col justify-center items-center relative z-10 text-center">
          ...
          <TextGenerateEffect
            words="Web Developer | 2+ Years Crafting Responsive, User-Friendly Websites"
          ...
          <p className="pt-5 pb-8 text-sm sm:text-base md:text-lg text-dark-200 dark:text-stone-200/70">
            Hi, I&apos;m Md Abdullah Ansari, I am a Web developer with 2+ years
            of experience creating responsive, user-focused websites and
            applications. Dedicated to clean code and great user experiences.
          </p>
